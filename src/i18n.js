...
export const translations = {
    fr: {
        ...
        "map.sidebar.title": "Rivières Surveillées",
        "map.sidebar.nodata": "Pas de données",
        "axis.djgc": "DJGC (°C·d)",
    ...
    en: {
        ...
        "legend.nodata": "Outside of the zone",
        "map.legendTitle": "Rivers Status:",
        "map.sidebar.title": "Monitored Rivers",
        "map.sidebar.nodata": "No data",
        "axis.djgc": "DJGC (°C·d)",
        "axis.djdc": "DJDC -5 °C (°C·d)",
        "axis.q": "Q (m³/s)",
